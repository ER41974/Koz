...
pub fn get_icon_path(theme: AppTheme, state: TrayIconState) -> &'static str {
    match (theme, state) {
        ...
        (AppTheme::Dark, TrayIconState::Done) => "resources/tray_done.png",
        // Light theme uses dark icons
        (AppTheme::Light, TrayIconState::Idle) => "resources/tray_idle_dark.png",
        (AppTheme::Light, TrayIconState::Recording) => "resources/tray_recording_dark.png",
        (AppTheme::Light, TrayIconState::Transcribing) => "resources/tray_transcribing_dark.png",
        (AppTheme::Light, TrayIconState::Done) => "resources/tray_done_dark.png",
        // Colored theme uses colored icons (for Linux)
        (AppTheme::Colored, TrayIconState::Idle) => "resources/handy.png",
        (AppTheme::Colored, TrayIconState::Recording) => "resources/recording.png",
        (AppTheme::Colored, TrayIconState::Transcribing) => "resources/transcribing.png",
        (AppTheme::Colored, TrayIconState::Done) => "resources/done.png",
    }
}
...
pub fn update_tray_menu(app: &AppHandle, state: &TrayIconState, locale: Option<&str>) {
    ...
    let version_label = if cfg!(debug_assertions) {
        format!("Koz v{} (Dev)", env!("CARGO_PKG_VERSION"))
    } else {
        format!("Koz v{}", env!("CARGO_PKG_VERSION"))
    };
    ...
    let menu = match state {
        ...
        TrayIconState::Idle | TrayIconState::Done => Menu::with_items(
            app,
            &[
                &version_i,
                &separator(),
